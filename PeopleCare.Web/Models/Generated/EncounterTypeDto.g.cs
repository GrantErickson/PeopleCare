...
{
    public partial class EncounterTypeParameter : GeneratedParameterDto<PeopleCare.Data.Models.EncounterType>
    {
        public EncounterTypeParameter() { }
        ...
        /// </summary>
        public override void MapTo(PeopleCare.Data.Models.EncounterType entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override PeopleCare.Data.Models.EncounterType MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new PeopleCare.Data.Models.EncounterType()
            {
                Name = Name,
            };
    ...
    public partial class EncounterTypeResponse : GeneratedResponseDto<PeopleCare.Data.Models.EncounterType>
    {
        public EncounterTypeResponse() { }
        ...
        /// </summary>
        public override void MapFrom(PeopleCare.Data.Models.EncounterType obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
