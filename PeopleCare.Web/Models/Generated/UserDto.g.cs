...
{
    public partial class UserParameter : GeneratedParameterDto<PeopleCare.Data.Models.User>
    {
        ...
        /// </summary>
        public override void MapTo(PeopleCare.Data.Models.User entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override PeopleCare.Data.Models.User MapToNew(IMappingContext context)
        {
            var entity = new PeopleCare.Data.Models.User();
            MapTo(entity, context);
            return entity;
        }
    }

    public partial class UserResponse : GeneratedResponseDto<PeopleCare.Data.Models.User>
    {
        public UserResponse() { }
        ...
        public System.Collections.Generic.ICollection<PeopleCare.Web.Models.UserRoleResponse> UserRoles { get; set; }

        /// <summary>
        /// Map from the domain object to the properties of the current DTO instance.
        /// </summary>
        public override void MapFrom(PeopleCare.Data.Models.User obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
            ...
            if ((context.IsInRoleCached("UserAdmin")))
            {
                ...
                if (propValUserRoles != null && (tree == null || tree[nameof(this.UserRoles)] != null))
                {
                    this.UserRoles = propValUserRoles
                        ...
                        .Select(f => f.MapToDto<PeopleCare.Data.Models.UserRole, UserRoleResponse>(context, tree?[nameof(this.UserRoles)])).ToList();
                }
