...
namespace PeopleCare.Web.Api
{
    ...
    public partial class UserController
        : BaseApiController<PeopleCare.Data.Models.User, UserParameter, UserResponse, PeopleCare.Data.AppDbContext>
    {
        public UserController(CrudContext<PeopleCare.Data.AppDbContext> context) : base(context)
        {
            GeneratedForClassViewModel = context.ReflectionRepository.GetClassViewModel<PeopleCare.Data.Models.User>();
        }
        ...
        public virtual Task<ItemResult<UserResponse>> Get(
            ...
            IDataSource<PeopleCare.Data.Models.User> dataSource)
        ...
        public virtual Task<ItemResult<UserResponse>> Save(
            ...
            [FromQuery] DataSourceParameters parameters,
            IDataSource<PeopleCare.Data.Models.User> dataSource,
            IBehaviors<PeopleCare.Data.Models.User> behaviors)
            ...
            [FromForm(Name = "role")] RoleParameter role)
        {
            ...
            var _methodResult = await PeopleCare.Data.Models.User.InviteUser(
                Db,
                invitationService,
                _params.Email,
        ...
        public virtual async Task<ItemResult> SetEmail(
            [FromServices] IDataSourceFactory dataSourceFactory,
            [FromServices] PeopleCare.Data.Auth.UserManagementService userService,
            [FromForm(Name = "id")] string id,
        ...
        public virtual async Task<ItemResult> SetPassword(
            [FromServices] IDataSourceFactory dataSourceFactory,
            [FromServices] Microsoft.AspNetCore.Identity.UserManager<PeopleCare.Data.Models.User> userManager,
            [FromServices] Microsoft.AspNetCore.Identity.SignInManager<PeopleCare.Data.Models.User> signInManager,
            [FromForm(Name = "id")] string id,
